...
export const generateStandardPDF = async (docTitle, docType, invoice, customer, items, settings, template = 'modern', color = '#2563eb', customFilePath = null) => {
    return new Promise(async (resolve, reject) => {
        try {
            ...
            doc.fillColor('#94a3b8').font(fontRegular).fontSize(8).text(`Thank you for your business. This is a computer-generated ${docTitle.toLowerCase()}.`, 50, doc.page.height - 40, { align: 'center', width: 495, lineBreak: false });

            if (settings?.showWatermark !== false) {
                doc.fillColor('#cbd5e1').font(fontRegular).fontSize(8).text('Generated by prolync billing', 50, doc.page.height - 25, { align: 'center', width: 495, lineBreak: false });
            }
